							...
							<section class="main">
								...
								<form action="${pageContext.request.contextPath}/board/boardUpdateOk.bo" name="updateForm" method="post" enctype="multipart/form-data">
									...
									<header class="major">
										...
										<p style="text-align:left; margin-bottom:1%; margin-top:-1.75em;">작성자 : <c:out value="${board.getMemberId()}"/></p>
									</header>
									...
									<div style="margin-top:3%;">
										<textarea name="boardContent" placeholder="내용 작성" style="resize:none;" rows="30"><c:out value="${board.getBoardContent()}"/></textarea>
									</div>
